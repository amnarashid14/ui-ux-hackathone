...
const Discount = () => {
  return (
   ...
   <Image src='/image/clockpicture.png' height={207} width={213} alt='Loading...' className='clockCard' />
      </div>
   ...
   <Image src='/image/cupboard2.png' height={100} width={100} alt='Loading...' className="cupBoard"/>
   </div>
   
      <div className="chairCard">
       <div className="w-full flex items-center gap-1">
         <div className="w-1/4 bg-[rgba(245,246,248,1)]">
         <Image src='/image/seat1.png' height={100} width={100} alt='Chair Picture' /></div>
